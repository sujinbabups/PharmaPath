...
jq '.channel_group.groups.Application.groups.PharmaciesMSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0.pharmacies.pharma.com","port": 11051}]},"version": "0"}}' config_copy.json >modified_config.json
...
peer lifecycle chaincode commit -o localhost:7050 --ordererTLSHostnameOverride orderer.pharma.com --channelID $CHANNEL_NAME --name Pharma-Chain --version 1.0 --sequence 1 --collections-config ../Chaincode/Pharma-Chain/collection-pharma.json --tls --cafile $ORDERER_CA --peerAddresses localhost:7051 --tlsRootCertFiles $MANUFACTURER_PEER_TLSROOTCERT --peerAddresses localhost:9051 --tlsRootCertFiles $WHOLESALER_PEER_TLSROOTCERT --peerAddresses localhost:11051 --tlsRootCertFiles $PHARMACIES_PEER_TLSROOTCERT --peerAddresses localhost:12051 --tlsRootCertFiles $REGULATOR_PEER_TLSROOTCERT
sleep 1s
...
# peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.pharma.com --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -n Pharma-Chain --peerAddresses localhost:7051 --tlsRootCertFiles $MANUFACTURER_PEER_TLSROOTCERT --peerAddresses localhost:9051 --tlsRootCertFiles $WHOLESALER_PEER_TLSROOTCERT --peerAddresses localhost:11051 --tlsRootCertFiles $PHARMACIES_PEER_TLSROOTCERT -c '{"Args":["PharmaSupplyChainContract:registerDrug","BATCH123","Paracetamol","BN12345","2025-12-31","2024-01-01","Manufacturer001"]}'
...
# peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.pharma.com --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -n Pharma-Chain --peerAddresses localhost:7051 --tlsRootCertFiles $MANUFACTURER_PEER_TLSROOTCERT --peerAddresses localhost:11051 --tlsRootCertFiles $PHARMACIES_PEER_TLSROOTCERT -c  '{"function":"distributeDrug","Args":["BATCH123", "WHOLESALER001", "2024-10-27T10:30:00Z", "Temperature Controlled"]}'
# peer chaincode query -C $CHANNEL_NAME -n Pharma-Chain -c '{"Args":["getDrugDetails","BATCH123"]}'
...
# export DRUG_NAME=$(echo -n "Aspirin" | base64 | tr -d \\n)
# export DOSAGE=$(echo -n "500mg" | base64 | tr -d \\n)
# export QUANTITY=$(echo -n "10" | base64 | tr -d \\n)
# export PHARMACY_NAME=$(echo -n "Pharmacy1" | base64 | tr -d \\n)
...
# peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.pharma.com --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -n Pharma-Chain --peerAddresses localhost:7051 --tlsRootCertFiles $MANUFACTURER_PEER_TLSROOTCERT --peerAddresses localhost:9051 --tlsRootCertFiles $WHOLESALER_PEER_TLSROOTCERT --peerAddresses localhost:11051 --tlsRootCertFiles $PHARMACIES_PEER_TLSROOTCERT -c '{"Args":["PharmaSupplyChainContract:registerDrug","BATCH123","Paracetamol","BN12345","2025-12-31","2024-01-01","Manufacturer001"]}'
# peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.pharma.com --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -n Pharma-Chain --peerAddresses localhost:7051 --tlsRootCertFiles $MANUFACTURER_PEER_TLSROOTCERT --peerAddresses localhost:11051 --tlsRootCertFiles $PHARMACIES_PEER_TLSROOTCERT -c  '{"function":"distributeDrug","Args":["BATCH123", "Wholesaler01", "2024-10-27T10:30:00Z", "Temperature Controlled"]}'
...
# peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.pharma.com --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -n Pharma-Chain -c '{"function":"verifyAndDispenseDrug","Args":["batch1", "PHARMACY001"]}' --peerAddresses localhost:12051 --tlsRootCertFiles $REGULATOR_PEER_TLSROOTCERT --peerAddresses localhost:11051 --tlsRootCertFiles $PHARMACIES_PEER_TLSROOTCERT --peerAddresses localhost:7051 --tlsRootCertFiles $WHOLESALER_PEER_TLSROOTCERT

#  peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.pharma.com  --tls  --cafile $ORDERER_CA  -C $CHANNEL_NAME  -n Pharma-Chain  -c '{"function":"verifyAndDispenseDrug","Args":["BATCH123", "PHARMACY001"]}'  --peerAddresses localhost:12051 --tlsRootCertFiles $REGULATOR_PEER_TLSROOTCERT --peerAddresses localhost:11051 --tlsRootCertFiles $PHARMACIES_PEER_TLSROOTCERT




# peer chaincode invoke  -o localhost:7050 --ordererTLSHostnameOverride orderer.pharma.com  --tls  --cafile $ORDERER_CA  -C $CHANNEL_NAME  -n Pharma-Chain  -c '{"function":"distributeDrug","Args":["BATCH123", "WHOLESALER001", "2024-11-01T10:00:00Z", "Temperature-Controlled"]}'--peerAddresses peer0.manufacturer.pharma.com:7051 --tlsRootCertFiles $MANUFACTURER_PEER_TLSROOTCERT  --peerAddresses localhost:11051 --tlsRootCertFiles $PHARMACIES_PEER_TLSROOTCERT

# peer chaincode invoke -o localhost:7050  --ordererTLSHostnameOverride orderer.pharma.com --tls --cafile $ORDERER_CA -C $CHANNEL_NAME  -n Pharma-Chain  -c '{"function":"auditSupplyChain","Args":["BATCH123"]}'  --peerAddresses localhost:12051 --tlsRootCertFiles $REGULATOR_PEER_TLSROOTCERT


# peer chaincode query -C $CHANNEL_NAME -n Pharma-Chain -c '{"Args":["readOrder","BATCH123","BATCH125"]}'


# peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.pharma.com --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -n Pharma-Chain --peerAddresses localhost:11051 --tlsRootCertFiles $PHARMACIES_PEER_TLSROOTCERT --transient "{\"drugName\":\"$DRUG_NAME\", \"dosage\":\"$DOSAGE\", \"quantity\":\"$QUANTITY\", \"pharmacyName\":\"$PHARMACY_NAME\"}" -c '{"Args":["createOrder", "ORDER123"]}'

# peer chaincode invoke -o localhost:7050  --ordererTLSHostnameOverride orderer.pharma.com  --tls  --cafile $ORDERER_CA  -C $CHANNEL_NAME  -n Pharma-Chain  --peerAddresses localhost:7051 --tlsRootCertFiles $MANUFACTURER_PEER_TLSROOTCERT  --peerAddresses localhost:11051 --tlsRootCertFiles $PHARMACIES_PEER_TLSROOTCERT -c '{"Args":["OrderContract:createOrder", "ORDER123"]}' --transient "{\"drugName\":\"$DRUG_NAME\", \"dosage\":\"$DOSAGE\", \"quantity\":\"$QUANTITY\", \"pharmacyName\":\"$PHARMACY_NAME\"}"  

# peer chaincode query -C $CHANNEL_NAME -n Pharma-Chain -c '{"Args":["OrderContract:readOrder","ORDER123"]}'
